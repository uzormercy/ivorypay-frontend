  ...
  return (
    <div className="bg-white border-[1px] border-solid border-[#EDEDED]">
        <div className="py-[32px] px-[28px] border-b-[1px] border-solid border-[#EDEDED]">
            <h6 className='text-[14px] font-[700] text-[#2586AE]'>FUND WALLET</h6>
        </div>
        <div className='flex p-[15px]'>
            <div className="w-[201px] flex flex-col gap-[45px] py-[27px] px-[12px] border-[1px] border-solid border-[#3D9EC6 bg-[#F3FCFF]">
                <div>
                    ...
                    <h6 className='text-[#4A5568] text-[14px] font-[700] leading-6'>123456434</h6>
                </div>
                <div>
                ...
                <div>
                    <span className='text-[12px] font-[400] leading-6 text-[#4A5568] uppercase'>BANK</span>
                    <h6 className='text-[#4A5568] text-[14px] font-[700] leading-6'>Guarantee Trust Bank</h6>
                </div>
            </div>
            ...
            <div className="w-[273px] ml-[46px]">
                ...
                <Button type="submit" title="FUND WALLET" />
            </div>
        </div>
    </div>
  )
